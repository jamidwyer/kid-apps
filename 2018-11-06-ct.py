...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['Connecticut legislative', 'elizabeth esty', 'March For Our Lives Coverage From CT', 'sandy hook victims', 'green party of Connecticut', 'Legislative Seats in CT', 'phil young', 'Connecticut Democrat flip Seat', 'legislative seats in Connecticut', 'flip GOP-held Connecticut seat', 'philyoungct', 'Connecticut Targeted In National Popular Vote Effort', 'Community Rallies Around Asian Couple Facing Deportation', 'ned lamont']
            for term in terms:
