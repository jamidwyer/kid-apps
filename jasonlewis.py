...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=1000):
        ...
        if submission.id not in posts_replied_to:
            ...
            if re.search("jason lewis'", submission.title, re.IGNORECASE):
                # Reply to the post
