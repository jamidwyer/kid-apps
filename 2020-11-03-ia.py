...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['sioux city rally', 'iowa, nevada, or california', 'we asked democratic activists who they', 'build out their iowa teams', 'viable candidate after Iowa City stop', 'entire town shows up for bernie', 'washing hands and talking to the next future president', ' 230 showed up for', 'sanders as a gadfly', 'giant democratic primary field', 'rourke returns to iowa', 'corporate middlemen', 'iowa kickoff speech', 'iowa caucus', 'iowa democrats', 'DACA student killed after being deported to Mexico', 'ICE deports Iowa HS student', 'Iowa student killed after being deported to Mexico', 'iowa\'s medicaid', 'zach wahls', 'iowa abortion ban', 'iowa race as house candidate', 'Burma Refugees Living in Des Moines', 'Bernie Sanders returns to Iowa', 'Iowa representatives', 'NRA president\'s Iowa business', 'ia-03', 'Factory Farming in Iowa', 'kim reynolds', 'Alasandro', 'Iowa\'s 3rd District race', 'austin frerick', 'Iowa Lawmakers', 'nate boulton', 'rob sand', 'Iowa Poll', 'Iowa went big for Trump', 'david young', 'anti-Iowa positions', 'Iowa Candidate', 'Running For Congress In Iowa', 'Trump sinks in Iowa', 'rod blum', 'rep. blum', 'congressman blum', 'rep blum', 'steve king', 'rep. king', 'rep king', 'representative king', 'Trump Hate Iowa', 'congressman king', 'ia-01', 'ia-4', 'ia-04']
            for term in terms:
