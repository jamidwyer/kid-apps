...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['3 grams of weed', 'voting is being suppressed in Alabama', 'This is your Democracy, Make it. Protect it. Pass it on', 'nai Sholom to honor mass shooting victims', 'Alabama 4th congressional dist', 'Hatch Act violation by Conway', 'Alabama 6th among states affected by tariffs', 'Voter registration numbers on the rise in Alabama', 'darwin brazier', 'armed heckler arrested', 'pulling a gun on immigration protesters', 'Alabama \'Families Belong Together\'', 'internment camps at Orange Beach and Silverhill', 'Gathering of the Masterrace.', 'sen. jones', 'shooting outside Walmart in Alabama', 'dougjones', 'VOTE ON JUNE 5', 'lee auman', 'Rocks tumbling into ocean causing sea level rise', 'mo brooks', 'recorded me going to my doctor and heckled me on the way out', 'alabama congressman', 'alabama elections chief', 'alabama state lege. seat', 'candidates in alabama', 'roy moore', 'alabama lawmaker', 'Etowah County sheriff', 'Alabama\'s 2018 elections', 'house seat in alabama', 'sue bell cobb', 'al-03', 'chris christie', 'bill passed by Alabama House', 'Alabama state House', 'jason childs', 'bradley byrne', 'Alabama violated federal law', 'Doug Jones', 'tommy battle', 'gerrymandered Alabama', 'Alabama\'s Secretary of State', 'Congressman Brooks town hall', 'al-gov', 'alabama governor', 'ala. gov', 'too poor to vote', 'Alabama Secretary of State', 'John Merrill', 'top election official learn from monitoring Russian election', 'Alabama election officials remain confused']
            for term in terms:
