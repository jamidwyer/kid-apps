...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=100):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['mia love', 'mia b. love', 'rep love', 'rep. love', 'representative love', 'congressman love', 'ut-04', 'ut-4', 'love\'s constituent meeting format', 'better way to talk with constituents']
            for term in terms:
