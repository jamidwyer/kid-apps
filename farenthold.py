...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['farenthold', 'tx-27', 'Congress plays by different rules on sexual harassment and misconduct', 'Texas Republicans Intentionally Discriminated Against Minority Voters', 'Republicans jolted by, and Democrats wary of, Trump']
            for term in terms:
