    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = [
                ...
                'renee fontenot', \
                'jeff landry', \
                '92 immigrants shackled on a plane', \
                'louisiana with a degree', 'louisiana workers', \
                'louisiana, alaskan tribes', \
                'redistricting table in Louisiana', \
                'louisiana is a republican', 'john bel edwards', \
                'Gulf Coast beaches closed due to algae bloom', 'planned ice raids', 'ICE shows up at your door', \
                'thc overdose', 'louisiana sports betting', 'LaPlace woman overdose on marijuana', \
                'the current state of American liberalism', \
                'us children are living below the poverty line', \
                'louisiana decided to curb mass incarceration', 'Louisiana Anti-Protest Law', \
                'district in louisiana', \
                'louisiana fall elections', 'twitter troll from baton rouge', \
                'Higgins campaign', \
                'louisiana congress', 'deepwater horizon', 'House of Representatives in Louisiana', 'Shreveport mayor', 'louisiana secession', 'la district 3', 'louisiana state lawmaker', 'louisiana lawmaker', 'louisiana elect', 'louisiana budget cuts', 'bayou bridge pipeline', 'tom schedler', 'la. house republican', 'louisiana legislat', 'wendy vitter', 'louisiana senators', 'louisiana law', 'louisiana senate', 'la. state senator', 'Dave Langlinais', 'la 3rd', 'LouisianaPolitics', 'Protest in Abbeville', 'deyshia hargrave', 'Vermilion school board', 'Vermillion school board', 'Louisiana district', 'Louisiana School District', 'Louisiana superintendent', 'most incarcerated state', 'scalise', 'clay higgins', 'Louisiana Prison ']
            for term in terms:
