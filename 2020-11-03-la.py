...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['I lost my job for refusing to hide climate crisis facts', 'with a straight face, gop leader', 'Gulf Coast beaches closed due to algae bloom', 'planned ice raids', 'ICE shows up at your door', 'thc overdose', 'louisiana sports betting', 'LaPlace woman overdose on marijuana', 'the current state of American liberalism', 'nungesser', 'us children are living below the poverty line', 'louisiana decided to curb mass incarceration', 'Louisiana Anti-Protest Law', 'renee fontenot', 'jeff landry', 'district in louisiana', 'david vitter', 'louisiana fall elections', 'twitter troll from baton rouge', 'Higgins campaign', 'louisiana congress', 'deepwater horizon', 'House of Representatives in Louisiana', 'Shreveport mayor', 'Citizens for a New Louisiana', 'louisiana secession', 'louisiana governor', 'la district 3', 'louisiana state lawmaker', 'louisiana lawmaker', 'louisiana elect', 'louisiana budget cuts', 'bayou bridge pipeline', 'tom schedler', 'la. house republican', 'louisiana legislat', 'wendy vitter', 'louisiana senators', 'louisiana law', 'louisiana senate', 'la. state senator', 'Dave Langlinais', 'la 3rd', 'LouisianaPolitics', 'Protest in Abbeville', 'deyshia hargrave', 'Vermilion school board', 'Vermillion school board', 'Louisiana district', 'Louisiana School District', 'Louisiana superintendent', 'most incarcerated state', 'scalise', 'clay higgins', 'Louisiana Prison ']
            for term in terms:
