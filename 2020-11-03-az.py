...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['equal rights amendment', 'photo of john mccain', 'uss john mccain', 'arizona supreme court', 'professor stands up to unethical', 'Maricopa early ballot', 'az gov', 'arizona republican', 'jerry demings', 'elected in arizona', 'az vote', 'arizona congress', 'az-sen', 'Phoenix ICE facility', 'arizona bill', 'mesa police', 'rally in Mesa', 'arizona gop', 'az education', 'kelly townsend', 'HB2663', 'arizona teacher strike', 'arizona teachers rally', 'arizona state capitol', 'AZ RedForEd', 'az08', 'education funding in arizona', 'DeWit to resign', 'rally in phoenix', 'azsen', 'az 06', 'rep. gallego', 'congressman gallego', 'scott menor', 'school vouchers in Arizona', 'grijalva', 'Arizona primary', 'Arizona Republican', 'candidates running in Arizona', 'Arizona Legislature', 'Scottsdale lawmaker', 'brailsford', 'ady barkan', 'Lea Marquez Peterson', 'daniel shaver', 'arpaio', 'gosar', 'Arizona Green Party', 'Oro Valley lawmaker', 'Arizona lawmaker', 'ducey', 'arizona governor', 'az. gubernatorial race', 'arizona\'s race for governor', 'arizona gubernatorial', 'arizona\'s republican governor', 'Congressman Biggs', 'andy biggs', 'az-5', 'az-05', 'rep biggs', 'rep. biggs', 'representative biggs', 'Congressman Tom O\´Halleran', '@RepOHalleran', 'o\'halleran', 'kevin cavanaugh', 'steve smith', 'schweikert', 'mcsally', '^(?!.*snowflake).*flake.*$', '@jeffflake', 'sinema', 'Kelli Ward']
            for term in terms:
