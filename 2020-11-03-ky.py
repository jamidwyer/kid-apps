...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['firefighting jobs with largest federal', 'lives are lost every day to our broken health care system', 'rep. yarmuth', 'kentucky ranks among worst states', 'toyota rebukes trump', '\"2019 Congressional District Census\"', 'remitcha', ' senate majority leader', 'mcconnell']
            for term in terms:
