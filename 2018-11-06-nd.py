...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['nd gop senate candidate', 'North Dakota candidate quits Senate race', 'emineth', 'heitkamp', 'Roll Back Fracking Standards', 'rep kevin cramer', 'congressman kramer', 'Can humane prisons work in America']
            for term in terms:
