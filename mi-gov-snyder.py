...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['rick snyder', 'governor snyder', 'gov snyder', 'gov. snyder', 'michigan governor', 'governor of michigan', 'michigan\'s governor', 'Michigan OKs limitless campaign spending', 'allow candidates to raise money for super PACs', 'ACLU sues Michigan for violating the 1st and 14th Amendments']
            for term in terms:
