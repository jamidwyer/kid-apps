...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['I was almost a school shooter', 'interference in presidential election hit Colorado', 'interference in presidential election hit Colorado voters', 'Chicken President Visits Denver', 't would like to remind you to update your voter info', 'Students, Teachers Call for Nationwide School Walkouts', 'Thoughts and Prayers and N.R.A. Funding', 'funding at the Office of Energy Efficiency and Renewable Energy', 'co ag candidate', 'colorado governor', 'colorado poll', 'Colorado GOP chairman convicted of voter fraud', 'colorado voters', 'emily sirota', 'Colorado Trump campaign supporters', '2018 Women\'s March in Denver', 'jared polis', 'days of CHIP funding left', 'Coloradans marched through the cold weather on Colfax', 'National Park Service advisory panel resign in frustration', 'Women\'s March Denver 2018', 'Colorado Cities Keep Voting To Build Their Own Broadband Networks', 'Colorado Just Had Its 3rd Warmest Year Ever', 'Colorado Might Gain a Congressional Seat', 'unkept promises on Dreamers, CHIP', 'State Where Everyone Wants to Be Governor', 'Colorado city moves ahead with muni broadband', 'CO is spending it\'s MJ tax revenue', 'Time to Nationalize the Internet', 'Doug Lamborn', 'ken buck', 'Voters can preserve net neutrality for their communities by authorizing municipal broadband', 'fight against Fort Collins municipal broadband', 'Colorado\'s investment in IUDs', 'former GOP party chairman in Colorado', 'steve curtis', 's Republican Party found guilty of voter fraud', 'Colorado becomes first in the nation to secure election system', 'Colorado CHIP notice letters sent out', 'mike coffman', 'co-06', 'co-6', 'rep. coffman', 'rep coffman', 'representative coffman', 'congressman coffman']
            for term in terms:
