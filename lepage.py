...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['lepage', 'maine governor', 'ME\'s next governor ', 'governor of maine', 'me gov', 'me governor\'s', 'gov. lepage', 'Uncertainty Surrounds Maine', 'Collins agonizes over decision to ditch the Senate', 'Maine plans to bring back high-risk pools', 'Maine Republicans: Strike', 'liar lepage', 'lepage blames']
            for term in terms:
