...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['scott walker', 'governor walker', 'wisconsin governor', 'wi gov', 'wi governor\'s', 'How Much Gerrymandering Is Too Much', 'Gorsuch was a pompous bore', 'Ginsburg Slaps Gorsuch in Gerrymandering Case', 'Return Control of Our Elections to the People', 'Did district lines rig Wisconsin elections', 'Redistricting Case That Could Remake American Politics', 'skeptical of partisan gerrymandering', 'Wisconsin\'s partisan gerrymander', 'Wisconsin Case Before Justices Could Reshape Redistricting', 'people prevented from voting in key swing state won by Trump', 'Cusp of Failing Before Our Eyes', 'state voter ID law confusion', 'Deterred Voters in Wisconsin', 'ID law kept up to 23,000 from voting', 'Wisconsin Strict ID Law', 'and Protection From Its Court System', 'under GOP health bill', 'site that critics call propaganda', 'Republican Governors Association', 'Republican Gov Association', 'lawmakers vote to pay Foxconn']
            for term in terms:
