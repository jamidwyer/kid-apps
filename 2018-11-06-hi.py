...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['gabbard', '30 years ago in Hawaii', 'Ending Federal Marijuana Prohibition Act', 'Impacts of sea level rise already being felt', 'Hawaiian Politician Is Introducing a Bill', 'Hawaii Expects Adult Use Cannabis Legalization', 'kaniela']
            for term in terms:
