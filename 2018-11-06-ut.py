...
def search(term, submission):
    if re.search(term, submission.title, re.IGNORECASE):
        ...
        text = ("Utah 2018 Election \n\n"
            "[Primary Election](https://vote.utah.gov/vote/menu/index): June 26, 2018 \n\n"
