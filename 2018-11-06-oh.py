...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['denniskucinich', 'Nina Turner to appear at Cuyahoga County', 'As Ohio moves away from coal', 'robert barr', 'kucinich', 'Ohio Attorney General', 'Republicans Are Trying to Kill a Key Voting Rights Law', 'Ohio purge of voter rolls', 'One vote decided 29 elections in Ohio in 2017', ' of Amazon employees on food stamps', 'Cincinnati\'s mini-Trump', 'Amazon Employees In Ohio', 'ohio senate frontrunner', 'ohio senate candidate', 'jay goyal', 'Ohio congressional candidates', 'rick neal', 'deported to Jordan after living in Ohio for 40 years', 'move to toss inactive voters from rolls goes to Supreme Court', 'Supreme Court to take up Ohio', 'Ohio House and Senate', 'stivers latest', 'Ohio\'s 16th District', 'proposed Ohio ballot initiative', 'Marijuana in Ohio', 'jimmy gould', 'cordray', 'stivers', 'mike turner', 'bob gibbs', 'jim jordan', 'jim renacci', 'dave joyce', 'discuss Ohio politics and candidates', '2018 elections in Ohio', 'representative latta', 'Ohio members of Congress', 'Representative Bill Johnson', 'bill o\'neill', 'steve chabot', 'rep. chabot', 'rep chabot', 'representative chabot', 'congressman chabot', 'oh-1', 'oh-01', 'ken harbaugh', 'josh mandel', 'kasich', 'ohio governor', 'oh gov', 'oh governor\'s', 'jerry springer', 'Mary Taylor']
            for term in terms:
