...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['Pittsubrgh anti-abortion health-care centers', 'anti-NRA billboard in Pittsubrgh', 'christina hartman', 'Admission decisions for Duquesne University applicants', 'Pitt Promises High Schoolers That Getting Suspended For Protesting Guns', 'Rick Santorum', 'rep costello', 'congressman costello', 'representative costello', 'rep. costello', 'Fighting to Save Democracy From Bribery and Gerrymandering', 'Pennsylvania Republicans aren\'t taking the new map', 'Impeaching P.A. Judges for Reversing Their Gerrymander', 'New Congressional Map in Pennsylvania', 'Pennsylvania\'s Gerrymandered Congressional Map', 'Daryl Metcalfe', 'Philly Greens', 'pennsylvania voters', 'Trump defending gerrymandering', 'PA\'s new congressional map', 'Court-Drawn Map in Pennsylvania', 'New map for Pennsylvania', 'Pennsylvania Supreme Court releases new congressional map', 'Pennsylvania Supreme Court draw', 'Pennsylvania House District', 'Court-Drawn Map in Pa.', 'hal english', 'pennsylvania voting map', 'new Pennsylvania map', 'pa. congressional map', 'turzai', 'Pennsylvania congressional map', 'Pennsylvania will require voting machines', 'Pennsylvania to require voting machines', 'Pennsylvania Republican launches effort', 'Pennsylvania GOP lawmaker', 'Pennsylvania congressional redistricting', 'Pennsylvania Republicans Delay', 'pa redistricting', 'Recreational Pot For Pennsylvania', 'Pennsylvania GOP\'s leading Senate candidate', 'Pa. governor', 'lou barletta', 'legalizing marijuana in PA', 'Vincent Hughes', 'PA\'s 16th Congressional', 'Pennsylvania coal mine closes', 'stable genius act', 'Pennsylvania redistricting', 'pennsylvania state senate', 'smucker', 'pa-16', 'joe billie', 'pa-7', 'pa-07', '^(?!.*john meehan).*meehan.*$', 'pennsylvania gerrymandering', 'ryan costello', 'Democrats back military veterans as candidates']
            for term in terms:
