...
def search(term, submission):
    if re.search(term, submission.title, re.IGNORECASE):
        ...
        text = ("Pennsylvania 2018 Election \n\n"
            "[General Election Registration Deadline](https://www.pavoterservices.pa.gov/Pages/VoterRegistrationApplication.aspx): October 9, 2018 \n\n"
