...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['pittsburghers Protest In Suppport Of Net Neutrality', 'rallying against the GOP tax scam in a Republican county in Pennsylvania', 'Bernie rally in Reading', 'smucker', 'pa-16', 'joe billie', 'pa-7', 'pa-07', 'meehan', 'pennsylvania gerrymandering suits', 'Vote for this guy if you live in PA', 'in PA, this guy is pretty good', 'ryan costello', 'Democrats back military veterans as candidates']
            for term in terms:
