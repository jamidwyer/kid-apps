...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['new york introduces new marijuana', 'kat brezler', 'new york attorney general', 'new york state\'s attorney general', 'new york city is creating jobs', 'knock down the house', 'knockdownthehouse', 'civil_ny keeping it real', 'sister retires to avoid fraud allegation', 'Protestors in NYC', 'No Blind People are Going to Live in Trump Tower', 'blake morris', 'new york repub', 'new york chapter of the proud boys', 'ny11', 'nyc bill passes', 'rally in Times Square', 'Democratic headquarters in Albany', 'opioid use in nyc', 'julia salazar', '^(?!.*aoch).*aoc.*$', 'bronx dsa', 'nyc public schoolteachers', 'yearning to breathe free', 'activists in new york', 'single payer new york health act', 'new york state assembly', 'taxi driver in debt', 'nadler', 'new york\'s housing crisis', 'preet bharara', 'marijuana charges in new york', 'zephyr', 'eric schneiderman', 'new york city dsa', 'new york state senat', 'howie hawkins', 'new york senate', 'steve stern', 'new york may legaliz', 'trump tower fire', 'fire at trump tower', 'ny-24', 'n.y. passes bill', 'kurt schlickter', 'green party of new york', '9/11 first responders', 'tenney', 'NY State bill', 'ny-21', 'Billionaires Row', 'ny-19', 'Ocasio', 'ny19', 'new york lawmaker', 'ny27', 'New York City\'s fossil fuel divestment', 'New York City Declares War on the Oil Industry', 'New York Finally Consider Legalizing Cannabis', 'sara idleman', 'peter king', 'katko', '^(?!.*burkina faso).*faso.*$', 'daniel donovan', 'dan donovan', 'ny-11', 'rep. donovan', 'rep donovan', 'representative donovan', 'congressman donovan', 'michael grimm', 'incumbent over Grimm']
            for term in terms:
...
def search(term, submission):
    if re.search(term, submission.title, re.IGNORECASE):
        ...
        text = ("New York 2020 Election \n\n"
            ...
            "[Primary Election](https://voterreg.dmv.ny.gov/MotorVoter/): April 28, 2019 \n\n"
