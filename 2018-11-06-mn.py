...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['mn-02', 'ilhan omar', 'compared gay people to rapists', 'mn dfl', 'minnesota gubernatorial', 'minnesota dfl', 'tim walz', 'and view themselves as victims', 'minnesota congress', 'justin vold', 'tina smith', 'jon applebaum', 'al franken', 'pawleny', 'pawlenty', 'minnesota state lawmaker', 'mary franson', 'keith ellison', 'Billboard in Hampton, MN', 'Spotted in Hampton, Minnesota', 'angie craig', 'MeToo Movement Is Coming to the Ballot Box This Month', 'all-in on defense in Minnesota', 'michele bachmann', 'Poison a Minnesota Wilderness', 'Am I Being Called to Do This Now', 'adam jennings', 'Pro-Trump Republican Rep Just Deleted Her Twitter', 'mary franson', 'Lt. Gov. Tina Smith', 'plans to gerrymander the Electoral College in three states', 'erik paulsen', 'rep. paulsen', 'rep paulsen']
            for term in terms:
