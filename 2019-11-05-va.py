...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['virginia supreme court', 'e.w. jackson', '36,000 Lawsuits Against Patients in 6 Years', 'rourke stumps in virginia', 'Democrats dump millions into statehouse races', '17 people that we have endorsed today', 'trumpsbodycount', 'freitas announces write-in campaign', 'virginia republican', 'speaker kirk cox', 'virginia, republican', 'colonial williamsburg', 'va-hd40', 'charlottesville car attack', 'va hd-66', 'vahousedems', 'flipvablue', 'big red boy', '^(?!.*west virginia attorney general).*virginia attorney general.*$', 'sen. amanda chase', 'senator amanda chase', 'equal rights amendment', 'virginia legislature', 'platform for legalizing child porn', 'smother gun control', 'votes and laws, not thoughts and prayers', '^(?!.*west virginia gop).*virginia gop.*$', 'virginia house of delegates', 'crying nazi','election in virginia', 'legalize virginia', 'party of white supremacy', 'marijuana in virginia', '^(?!.*west virginia gop).*virginia gop.*$', 'heather heyer', 'danica roem', 'unite the right', 'jason kessler', '^(?!.*west virginia congressional candidate).*virginia congressional candidate.*$', 'Congressional Candidate In Virginia', '^(?!.*west virginia senat).*virginia senat.*$', 'virginiapolitics', 'errymandering in virginia', 'Va. House', 'Virginia Congressional Election']
            for term in terms:
