...
def search(term, submission):
    if re.search(term, submission.title, re.IGNORECASE):
        ...
        text = ("West Virginia 2020 Election \n\n"
            "[Register to Vote](https://ovr.sos.wv.gov/Register/Landing#Qualifications) \n\n"
