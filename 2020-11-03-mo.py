...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['devito introducing bernie', 'black drivers in missouri', 'Threats and intimidation for an officer', 'union pacific workers given 2 days notice', 'emergencies, galloway', 'missouri supreme court', 'billy long', 'curtis wylde', 'missouri trims its medicaid', 'judge blocks missouri', 'missouri women to be charged with felonies', 'St. Louis County Pays Woman', 'panic at missouri walmart', 'nicole galloway', 'missouri governor', 'missouri medicaid', 'mo auditor', 'missouri abortion', 'lucile bluford', 'cori bush', 'black missouri drivers', 'Right Gets Tired of Democracy', 'forced by the state of missouri', 'hope Clinic for Women', 'missouri taxpayer', 'Missouri is \'leaking\' sales tax revenue', 'rally in missouri', 'rally in Cape Girardeau', 'missouri senat', 'st. louis abortion', 'billy long', 'missouri house', 'missouri gubernatorial', 'st. louis prosecutor', 'ferguson reformer', 'missouri election', 'ferguson prosecutor', 'missouri gop', 'wesley bell', 'bob mcculloch', 'right to work in missouri', 'missouri prison', 'missouri state primary', 'missouri vote', 'missouri 2020 primary', 'j.p johnson', 'mo-7', 'st. louis minimum wage', 'missouri congress', 'michael brown was shot', 'curtiswylde', 'greitens', 'lauren arthur', 'missouripolitics', 'ferguson city council', 'missouri house moves', 'kc voters', 'osmack', 'missouri bill', 'new approach missouri', 'Missouri lawmaker', 'austin petersen', 'Missouri Medical Marijuana Campaign', 'josh hawley', 'courtland sykes', 'US Senate in Missouri', 'MO GOP Senate Nomination', 'snake-filled heads', 'career obsessed banshees', 'Missouri pregnancy mortality', 'sam graves', 'Blaine Luetkemeyer', 'kathy ellis', 'mccaskill', 'ann wagner', 'mo-2', 'jenna marie bourgeois', 'hartzler', 'mo-4']
            for term in terms:
