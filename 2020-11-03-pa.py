...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['good person and i smoke weed', 'coerced workers into attending a Trump rally', 'universal background checks are off the table', 'trump says pennsylvania chemical plant', 'Shell Workers Had To Attend Trump Speech', 'Same Lie for the 80th Time', 'pa rally', 'trumpsbodycount', 'data on white supremacist terrorism', 'white nationalist killers', 'law lets pennsylvania', 'freed after 27 years in prison', 'person of color. I\'m white', 'White GOP congressman says he isn', 'political power from urban pennsylvania', 'robber returns money to philly store', 'FBI and ICE use DMV photos', 'courthouse in hanover, pa', 'pa-10', 'senatormuth', 'Ten cities say Trump owes them money', 'legislation that would benefit victims of child sex abuse', 'Sunday collections on political lobbying', 'economic patriotism', 'nfL player aims to destigmatize marijuana use', 'pennsylvania transgender', 'Trump Would Have Lost Election Without Russian Help', 'pennsylvania statehouse', 'key states like pennsylvania', 'philadelphia prosecutor', 'trump would beat biden', 'ajit pai gets a whopping', 'poll numbers in pennsylvania', 'dropped a bomb on a black neighborhood', 'haircuts to the homeless in the middle of a busy street', 'synagogue massacre', 'atrocities like pittsburgh', 'pittsburgh massacre', 'tree of life synagogue', 'pittsburgh shoot', 'robert bowers', 'jews in pittsburgh', 'pennsylvania rally', 'pa-08', 'pa-17', 'pa-01', 'bob casey', 'brendan boyle', 'pa-7', 'pa-07', '^(?!.*john meehan).*meehan.*$', 'pa hd150', 'pa-7', 'pa state rep', 'pennsylvania primaries', 'pennsylvania governor', 'primary in Pennsylvania', 'primaries in pennsylvania', 'pa34', 'summer lee', 'progressives in pennsylvania', 'innamorto', 'pa state house', 'pa hd-178', 'socialists in pennsylvania', 'terri mitko', 'fetterman', 'pa 184', 'candidate in pennsylvania', 'pa11', 'house race in pennsylvania', 'impeach PA Supreme Court', 'santorum', 'pa01', 'pennsylvania Republican state legislator', 'larry krasner', 'pa gerrymandering', 'Women Run in Pennsylvania', 'nick miccarelli', 'saccone', 'conor lamb', 'pa.\'s redistricting', 'christina hartman', 'rep costello', 'congressman costello', 'representative costello', 'rep. costello', 'New Congressional Map in Pennsylvania', 'Pennsylvania\'s Gerrymandered Congressional Map', 'Daryl Metcalfe', 'pennsylvania voters', 'PA\'s new congressional map', 'New map for Pennsylvania', 'Pennsylvania House District', 'hal english', 'pennsylvania voting map', 'new Pennsylvania map', 'pa. congress', 'turzai', 'Pennsylvania congress', 'Pennsylvania GOP lawmaker', 'pa redistricting', 'Pennsylvania GOP\'s leading Senate candidate', 'Pa. governor', 'lou barletta', 'marijuana in PA.', 'Vincent Hughes', 'PA\'s 16th Congressional', 'stable genius act', 'Pennsylvania redistricting', 'pennsylvania state senate', 'smucker', 'pa-16', 'joe billie', 'pennsylvania gerrymandering', 'ryan costello']
            for term in terms:
