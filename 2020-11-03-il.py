    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = [
                ...
                'black preteen who is shot by police', 'Bill To Reschedule And Research Marijuana', \
                'pritzker signs bill', 'illinois becomes first state', 'illinois for legal', \
                'weed cafes in illinois', 'illinois is expunging marijuana', 'Trump Says Employee At Chicago', \
