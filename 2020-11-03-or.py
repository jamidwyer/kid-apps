...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['Trump falls short on infrastructure', 'blumenauer', 'oregon vot', 'bend city council', 'mcleod-skinner', 'buehler', 'oregon legislat', 'portland dsa', 'kate brown', 'campaigning in Oregon', 'alex diblasi', 'oregon primaries', 'National Popular Vote Interstate Compact', 'Oregon passes net neutrality law', 'oregon governor', 'march today in eugene, oregon', 'val hoyle', 'oregon republican lawmaker', 'multnomah county gop', 'oregon senate', 'dallas heard', 'Oregon House passes', 'Oregon constitutional amendment', 'sen. kruse', 'senator kruse', 'sen kruse', 'Oregon\'s Senate Rules Committee', 'greg walden', '@repgregwalden', 'rep. walden', 'congressman walden', 'rep walden']
            for term in terms:
