...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['alaska lawmaker', 'transgender bathroom bill just turned up in', 'alaska politicians', 'Bill Wielechowski', 'Alaska among states compromised before 2016 election', 'don young']
            for term in terms:
