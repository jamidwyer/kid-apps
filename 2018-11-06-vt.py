...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['Skewers Vermont Pols', 'vermont gov', 'vermont senate', 'Burlington VT to protest a Patriot Front', 'Vermont Legalizes Recreational Marijuana', 'West Virginia, Lowest in Vermont', 'Vermont is the first state to legalize marijuana', 'Vermont Becomes the Ninth State to Legalize Adult Marijuana', 'Vermont has officially legalized cannabis', 'Governor Scott sticks it to the taxpayers', 'GOP in Vermont']
            for term in terms:
