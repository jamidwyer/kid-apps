...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['georgia boycott', 'Airplane Discount For NRA', 'Antigay Adoption Bill Moves Towards Passage in Georgia', 'Dekalb schools approach on potential student walk', 'Ossoff decides against', 'lesbians from adopting passes in Georgia', 'trent nesmith', 'five states without a paper trail of votes', 'Georgia adoption agencies deny service to gay couples', 'Prevent Another Decade of GOP Gerrymandering', 'Fat fuck cops suffocate man to death', 'Gwinnett State House district', 'georgia legislators', 'Georgia Democrats are zeroing in', 'georgia governor', 'Leaning States Drop From 44 to 39', 'georgia 6th', 'georgia lawmakers', 'Georgia Midterms', 'fran millar', 'Black Women Vote More, But Remain Underrepresented in Politics', 'Lawmakers propose switching Georgia', 'doug collins', 'rep. collins', 'rep collins', 'Reddest district in Georgia', 'representative collins', 'congressman collins', 'ga-9', 'ga-09', 'Georgia turns blue', 'kevin abel', 'Crackdown On Unlicensed Ga. Facilities', 'Republicans dust off Georgia special election playbook for midterms', 'State Legislators Across the Country Are Joining Forces to Fight for Reproductive', 'Trump approval rating 36.7' 'approval ratings in Georgia erode', ' Disapproval in Georgia', 'female political activism that could shift the course of US politics', 'GA House of Representatives', 'Georgia\'s Election System', 'Dozens of People Arrested for Less Than an Ounce of Weed', 'arrests of over 60 Georgia partygoers', 'Police arrested 63 people at a house party', 'Poverty Is Both a Political and a Moral Choice Made By the Powerful', 'Journalist found guilty of obstruction of justice after suing Sheriff Candidate', 'In Georgia, battle of the \'Staceys\'', 'jeffares' 'buddy carter', 'lisaringga', 'lisa ring', '@repbuddycarter']
            for term in terms:
