...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['gowdy', 'Congressional Russia Inquiries as Parties Clash', 'Fear Him', 'Republicans who obsessed over Benghazi', 'The Republican Plan to Use the Steele Dossier to Attack James Comey']
            for term in terms:
