...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['green party of new york', 'nra-backed n.y. pols', '9/11 first responders', 'tenney', 'NY State bill', 'ny-21', 'Billionaires Row', 'ny-19', 'Alexandria Ocasio-Cortez', 'take a look at Saudi Arabia, open the documents', 'ny19', 'Self-employed carpenter couldn\'t afford to go to the doctor', 'new york lawmakers', 'Governor Cuomo', 'Women\'s March on NYC', 'New York gov', 'hoping for a terrorist attack to counter 2018 elections', 'nyc women\'s march', 'A man who knows. Women', 'Trump suggests that a terror attack could help Republicans in the 2018 midterms', 'terror attack could save him and GOP from 2018 election bloodbath', 'New York City homeless shelter faces resistance', 'New York to look at legalizing recreational marijuana', 'Marijuana legalization may be coming to New York sooner rather than later', 'ny27', 'New York City\'s fossil fuel divestment could spur global shift', 'New York City Declares War on the Oil Industry', 'New York Finally Consider Legalizing Cannabis', 'New York Police Union Sues to Stop Release of Body Camera Videos', 'Fund Early Voting', 'Republicans Poised for Collapse in New York', 'sara idleman', 'New York introduces its own net neutrality bill', 'barely disguised reward for billionaire donors', 'GOP tax plan the result of a runaway campaign finance system', 'peter king', 'Net Neutrality Supporters At NYC Verizon Store', 'House Seats Democrats Are Hoping to Win in 2018', 'GOP Tax Bill Displays American Oligarchy', 'katko', '^(?!.*burkina faso).*faso.*$', 'daniel donovan', 'dan donovan', 'ny-11', 'rep. donovan', 'rep donovan', 'representative donovan', 'congressman donovan', 'michael grimm', 'GOP incumbent over Grimm']
            for term in terms:
