...
def searchAndPost(sub):
    ...
    for submission in subreddit.top('month'):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['rodney davis', 'rep. davis', 'rep davis', 'representative davis', 'congressman davis']
            for term in terms:
