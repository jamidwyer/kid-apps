    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = [
                ...
                'ban on assault weapons', 'Non-Partisan Nevadan', 'first-in-the-West caucus', 'supporters in nevada', 'second place in nevada', 'macedonian fake news', \
                'rally planned for las vegas', 'nevada delegation', \
                'sanders in las vegas', 'sanders in reno', 'sisolak veto', 'nevada\'s women lawmak', \
                'vegas town hall', \
                'las vegas cannabis', 'nuclear waste to yucca mountain', 'sad as it is necessary', 'Nevada, elect', \
                'candidate in nevada', 'hillary schieve', 'nevada\'s rosen', \
