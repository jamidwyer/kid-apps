...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['sanders visits las vegas', 'sheldon adelson', 'child sex ring in las vegas', 'cohen uncovered a pedophile', 'Deleted Scene May Have Exposed Elite Pedophile Sex Ring', 'Sanders Town Hall over medical bills', '160k in debt and contemplating suicide', 'Navy vet says that he has stage-4 Huntington', 'medical debt how he plans on paying it off', 'now ban ar-15s', 'leads in nevada', 'ban on assault weapons', 'Non-Partisan Nevadan', 'launches effort to combat voter suppression', 'rhetoric for mass shootings', 'who we are as nevadans', 'attack synagogues, gay bar in Las Vegas', 't want a gay son', 'Bernie Sanders Town Hall Aug', 'failure to repeal the Affordable Care Act shows the power of a mobilized public', 'gilroy', 'first-in-the-West caucus', 'supporters in nevada', 'second place in nevada', 'macedonian fake news', 'rally planned for las vegas', 'nevada delegation', 'sanders calls for house to start impeachment', 'sanders in reno', 'sisolak veto', 'nevada\'s women lawmak', 'vegas town hall', 'las vegas cannabis', 'nuclear waste to yucca mountain', 'sad as it is necessary', 'Nevada, elect', 'candidate in nevada', 'hillary schieve', 'nevada\'s rosen', 'Las Vegas festival mass shooting', 'congressperson in nevada', 'nevada ballot', 'picket in las vegas', 'las vegans protest', 'brothel owner hof', 'cortez masto', 'trump in Vegas', 'nevada gop', 'las vegas union', 'nevada primary', 'Nevada 4th Congressional District', 'pat spearman', 'washoe county sheriff', 'nevada voter', 'Vegas shooter', 'John Anzalone', 'nv caucus', 'Clark County DA', 'nevada ag', 'nv assembly', 'living wage in nv', 'nevada assembly', 'Las Vegas massacre', 'nevada poll', 'banning bump stocks', 'nevada politic', 'nv04', 'nv-03', 'nv-02', 'NV GOP wants to', 'kate marshall', 'Las Vegas shooting', 'Nevada House, Senate races', 'jay craddock', 'nevada legislat', 'amodei', 'Nicole Cannizzaro', 'Nevada\'s 4th District Race', 'laxalt', 'kihuen', 'oscarson', 'Nevada Supreme Court justice', 'amy vilela', 'State Senate Recall', 'michael roberson', 'Richard McArthur', 'tony smith', 'sisolak', '^(?!.*hellerweather).*heller.*$', 'sbaih', 'Nevada GOP', 'jared fisher', 'governor sandoval', 'nevada governor', 'NV\'s next governor ', 'governor of nevada', 'nv gov', 'nv governor\'s']
            for term in terms:
