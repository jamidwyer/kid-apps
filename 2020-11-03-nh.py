...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['Nursing Home in their effort to unionize', 'lewandowski', 'biden can still be declared the winner', 'leads in new hampshire', 'leading by 8 in nh', 'nh democrat', 'unhinged display should frighten everyone', 'donald trump is terrified', 'a hit in n.h.', 'new hampshire primary', 'Trump supporter here in North Conway', 'campaign stop in Peterborough', 'nh-sen', 'new hampshire rally', 'nh pride parade', 'Spending The Day On The Trail With Andrew Yang', 'town hall in londonderry', 'throw their rear ends in jail', 'nh poll', 'new hampshire supreme court', 'dinesh d', 'nhpolitics', 'New Hampshire seat in Trump district', 'spagnuolo', 'New Hampshire House vot', 'New Hampshire Lawmakers', 'New Hampshire vote']
            for term in terms:
