...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['Kentucky state legislature', 'Deep-Red Kentucky Seat', 'flip kentucky seat', 'Democrats are running 28 points ahead of Clinton', 'Kentucky State House seat', 'murderous rampage last weekend in Kentucky was not exceptional', 'kentucky lawmaker', 'Trump campaign chair in KY', 'Doctors floored by epidemic levels of black lung in Appalachian coal miners', 'state legislature in historic numbers in NKY', 'Do the Poor Deserve Health Care', 'Proposed Kentucky Law', 'ky becomes the first state to deny medical care to those who are poor and unemployed', 'asking people to work with an anchor on their back', 'New Kentucky law', 'policy on how states can stop people from receiving Medicaid', 'states to force Medicaid recipients to work', 'kim davis', 'andy barr', 'rep. barr', 'rep barr', 'representative barr', 'congressman barr', 'kentucky\'s 6th congressional district', 'ky-6', 'ky-06', 'Kentucky\’s 6th Congressional District']
            for term in terms:
