...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['250,000 for Memphis from budget', 'Memphis in budget as punishment for Confederate statue removal', 'sentencing reform in tennessee', 'ice raid in a small tennessee town', 'tn house passes bill', 'These guys call themselves patriots', 'vanhuss', 'tn6', 'bill halted in tennessee', 'tn state Representative', 'scale of opioid epidemic in Appalachia', 'Photos I took from the March For Our Lives rally', 'bad diane.', 'memphis trees community', 'My Favorite sign from today', 'march for our lives 10am', 'March for Our Lives - downtown saturday morning', 'lee beaman', 'driving all over nashville not looking at the road', 'dawnbarlow', 'tennessee Republicans fail', 'tennessee Republicans refuse', 'tn01', 'hume-fogg in downtown nashville', 'state Representative for tennessee', 'draining the treasury even faster than expected', 'tennessee gop kill bill', 'corker out', 'oddie shoupe', 'Tennessee Heritage Protection Act', 'TN State Legislature', 'phil roe', 'Greenville local races', 'House Bill 2381', 'Tennessee bill', 'dum a\*\* women', 'Tennessee to legalize medical marijuana', 'TN Representative Candidate', 'tennessee lawmaker', 'Tennessee Republican files bill', 'running for the House seat for Anderson County', 'john duncan', 'Republican net neutrality bill', 'Tennessee House Republicans', 'corker kick back', 'Corker asks', 'corker kickback', 'corkerkickback', 'corker demands', 'CORker says', 'Tennessee Chooses, 2018', 'Senate in Tennessee', 'TN Democrats Vote', 'bredesen', 'kustoff', 'tennessee governor', 'tn gubernatorial', 'gov. of tn', 'tennessee gubernatorial candidate', 'governor haslam', 'randy boyd', 'kay white', 'tn governor', 'House Budget chair', 'Diane Black', 'bill lee', 'beth harwell', 'karl dean', 'mae beavers', 'tennessee senate race', 'bob corker', 'sen. corker', 'mackler', 'blackburn', 'corker\'s u.s. senate seat', 'replace corker', 'disgusting lies about Planned Parenthood', 'Corker fight', 'baby body parts', 'Berke considering run', 'andy ogles', 'senator corker', 'Corkers seat', 'tn-6', 'tn-7', 'tn-07']
            for term in terms:
