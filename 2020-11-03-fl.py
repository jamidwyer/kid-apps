...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['coral gables clerk of courts', 'plan to end offshore drilling', 'fundraiser in florida', '1.4 million people from voting', 'ups driver killed in shootout', 'Cops Use Civilians as Literal Human Shields', 'george buck', 'only grocery closed, city hall', 'dem in florida', '1.1 million gallons a day from Florida', 'New York Times subscription. Officials refused', 'Republicans have lost their damn minds', 'florida minimum wage', 'Admits He Could Have Gone to Impeachment Hearings', 'trump says his florida', 'no longer hosting G7', 'moron plan to host G7', 'miami beach unanimously declares', 'miami beach declares', 'supporters in florida', 'G-7 Meeting In Doral', 'oscar h. blayton', 'sarasota vot', 'trump at golf club', 'trump doral', 'Floridians overwhelmingly support legalizing', 'millennials in miami', 'corporate giveaway of florida', '2,300 conflicts of interest', 'NZ but nope they wanna put dogs at risk', ' will cost voters ', 'school shootings prevented: 0', 'florida man pulls gun', '2020 initiative to legalize recreational marijuana', 'rally suggests shooting migrants', 'Dwyane Wade is retweeting Beto', 'Trump supporter apologizes on Obama', 'florida board of education', 'Board of Education Chairman is an Evolution Denier', 'Florida just declared a public health emergency', 'California with three suitcases worth of pot', '15,600 deaths', 'Mueller Testimony Implicates Trump in Committing Perjury', 'fl59', 'broward lawmaker', 'alan dershowitz', 'miami\'s trump tower', 'florida county cannot ban', 'florida migrant detention', 'ted yoho', 'Congressman Who Grilled Mark Zuckerberg About Vaccines', 'rally in orlando', 'orlando rally', 'dolphins along the gulf coast', 'trayvon martin', 'make america straight again', 'Marijuana Employment Policies', 'give up your password or go to jail', 'florida ex-felons registered to vote', 'regulate florida', 'florida man threatens to eat cops', '22 million for trumps border wall', '17m to build trump', '16m to build trump', 'trump would beat biden', 'Florida radio stations vow to broadcast Trump', 'lose house because he didn\'t mow his lawn', 'we the people will build the wall', 'bills die in florida', 'i eat ass', 'judge orders florida', 'Florida Man Arrested After Inviting Police Officer to Smoke a Bowl With Him', 'florida will ban', 'behead bernie sanders', 'florida and the 2020', 'rallies for florida', 'weed in florida', 'tallahassee yoga shoot', 'florida politic', 'anthony borges', 'democrats win florida', 'cesar sayoc', 'maga bomber', 'magabomber', 'flip florida', 'shalala', 'george zimmerman', 'pam bondi', 'ballots in florida', 'gillum', 'parkland teens', 'florida state house', 'melissa howard', 'miami-dade teachers', 'cameron_kasky', 'lee mangold', 'florida republican', 'commissioner of agriculture of florida', 'vern buchanan', 'fl-16', 'jeremy ring', 'mar-a-lago', '33 Million To Keep A Child Detention Center Open', 'fl gop', 'algae bloom threatens Florida', 'fladems', 'Lake Okeechobee Algae Bloom', 'FL-21', 'fl governor', 'aron davis', 'parkland survivor', 'fl-gov', 'nelson campaign', 'scottforflorida', 'orlando massacre', 'orlando mass shooting', 'pulse shooting', 'senator nelson', 'Gary Wayne Lindsey', 'gerrymandering in florida', 'save rural florida', 'school safety commission', 'adam putnam', 'parkland kid', 'bill nelson', 'parkland parents', 'joe negron', 'lauren baer', 'mayor of tallahassee', 'hogg wild', 'scott-nelson', 'fl-6', 'parkland student activist', 'david hogg', 'Emma Gonzales', 'parkland shoot', 'wildlife conservation council', 'florida legislators', 'stoneman douglas students', 'flgov', 'florida state senator', 'fla. senate', 'kelli stargel', 'florida senate', 'florida poll', 'gwen graham', 'fl lawmaker', 'Tampa Bay lawmaker', 'Florida GOP', 'florida lawmaker', 'Florida House', 'debra kaplan', 'Tom Rooney', 'march for our lives', 'Florida high school shooting', 'florida school shooting', 'margaret good', 'Miami congressional campaign', 'Posey for Congress', 'Peters4Congress', 'Florida congressman', 'philip levine', 'sean shaw', 'Proposed Florida amendment', 'vote in Florida', 'victor torres', 'Florida Congressional District 3', 'Florida vot', 'florida legislature', 'Anna Eskamani', 'FL House district 31', 'matt haggman', 'Kelly Smith for Pasco County Commissioner', 'Orlando Lawmakers', 'ron reid', 'florida marijuana', 'bilirakis', 'marijuana in Fl', 'cannabis in florida', 'Florida Cannabis Act',  '^(?!.*klatvala).*latvala.*$' '^(?!.*gov. scott walker).*gov. scott.*$', 'Florida HD-58', 'gaetz', '2018 congressional races in Florida', 'rick scott', 'Florida Democrat', '^(?!.*governor scott).*governor scott.*$', 'florida governor', 'fla. governor', 'governor of florida', 'curbelo', 'brian mast', 'rep mast', 'rep. mast', 'representative mast', 'congressman mast', 'fl-18', 'lehtinen', 'fl-27', 'desantis', 'dennis ross', 'fl-15', 'andrew learned', 'balart', 'fl-25']
            for term in terms:
