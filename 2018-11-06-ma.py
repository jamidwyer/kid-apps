...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['jim mcgovern', 'For those who claim their votes don’t matter', 'sanctuary from marijuana prosecution', 'MA voters could register and vote on same day', 'legal marijuana in Massachusetts', 'Cambridge women\'s march looking majestic af', 'Boston PD only required 100 out of 2,000 cops to wear body cams', 'oldest cities what sea-level rise really means', 'alexandra chandler']
            for term in terms:
