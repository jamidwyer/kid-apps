...
def search(term, submission):
    if re.search(term, submission.title, re.IGNORECASE):
        ...
        text = ("Iowa 2018 Election \n\n"
            "[Primary Election Registration Deadline](https://mymvd.iowadot.gov/Account/Login?ReturnUrl=%2fVoterRegistration): May 25, 2018 \n\n"
