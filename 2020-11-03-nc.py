    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = [
                ...
                'tillis challenger', 'christopher holliday', 'thom tillis', ' nc environment', 'voting in north carolina', \
                'republican behind north carolina', 'north carolina rally', 'crime victims in nc', 'nc vot', \                
                'republicans in north carolina', 'gerrymandering in north carolina', 'silent sam', 'north carolina constituion', 'nc gop', \
