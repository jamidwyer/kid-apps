...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['debbie dingle', 'detroit transportation', 'michigan sues', 'ice set up a fake university', 'can\'t act like we don\'t exist', 'billionaires are going to stop ripping off communities', 'Bernie Sanders is the only candidate I trust', 'elections fair in michigan', 'michael moore', 'rashida talib', 'trump win michigan', 'Failing in Wisconsin, Pennsylvania and Michigan', 'mackinac island where motorized vehicles are banned', 'ann arbor group aims to decriminalize', 'UAW calls national strike against GM', 'when henry met lizzie', '50,000 naloxone kits', 'Will Smith and his son doing some good', 'easier to fire women who act', 'garypeters', 'may god ruin trump', 'coverage of his racism', 'Trump Won Because Of Lower Democratic Turnout', 'Trump supporters deported back to Iraq', 'Jimmy Aldaoud', 'MI, MN and WI', 'second democratic debate', 'detroit police board', 'inslee opposes pipeline plan', 'debate in detroit', 'unflattering numbers leak', 'DNC Army That Could Soon Descend', 'flint officials', 'what happened in flint', '12 points in michigan', 'Michigan Doctor Accused of Overprescribing', 'michigan jail', 'michigan lawmak', 'dems in michigan', 'michigan democrat', 'michigan absentee', 'devos family', 'candidates in michigan', 'clean water for michigan', 'votes in michigan', 'michigan poll', 'mi11', 'tlaib', 'vote in michigan', 'michigan primary', 'tom mair', 'michigan redistricting', 'gerrymandered michigan', 'fix flint', 'water in flint', 'Flint, Michigan', 'niles niemuth', 'upton stands against', 'Michigan Department of Civil Rights', 'gubernatorial candidate in Michigan', 'ballot in michigan', 'legalization in michigan', 'eponine garrod', 'state house in lansing', 'detroit dsa', 'governor in michigan', 'dana nessel', 'edgar prince', 'poppy sias', 'bobby holley', 'Michigan House votes', 'gerrymandering in Michigan', 'Green Party of Michigan', 'Mich. ballot campaign', 'john dingell', 'Rep. Dingell', 'abdulelsayed', 'brenda lawrence', 'Michigan Senate candidate', 'saari', 'schuette', 'Flint drinks poison', 'Michigan ballot', 'el-sayed', 'Michigan Legalize Marijuana', 'Michigan Legalizes Marijuana', 'HENRY YANEZ', 'gretchen whitmer', 'Tim Kelly', 'Michigan still a blue state', 'Joe Schwarz', 'Political Issues in Michigan', 'sandy levin', 'jack bergman', 'marijuana legalization in Michigan', 'fred upton', 'mi-06', 'mi-6', 'michigan\'s 6th District', 'rep. upton', 'rep upton', 'representative upton', 'congressman upton', 'benac', '^(?!.*trotte).*trott.*$', 'michigan congress', 'Michigan Republican', 'mike bishop', 'rep. bishop', 'rep bishop', 'representative bishop', 'congressman bishop', 'mi-08', 'mi-8', 'Michigan\'s 8th District', 'rick snyder', 'governor snyder', 'gov snyder', 'gov. snyder', 'michigan governor', 'governor of michigan', 'michigan\'s governor', 'stabenow', 'john james', 'Robert Ritchie', '^(?!.*yamashiro).*amash.*$', 'mi-03', 'mi-3', 'michigan\'s 3rd District']
            for term in terms:
