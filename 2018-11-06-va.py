...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['Alcohol Treatment, Won’t Run Again for House Seat', 'alcoholic, won\'t seek re-election', 'virginiapolitics', '16 named storms and up to 4 major hurricanes this season', 'cynthia dunbar', 'health care premiums skyrocketing in Virginia', 'richardbspencer', 'richard spencer', 'We must defend the rich-errr white rac', 'only 13.44', 'house bill 83', '61-year-old woman fights a gas pipeline', 'Opioid Overdoses Killed Over 1,200 Va. Residents', 'Republicans Are a No Show Across the Country for Town Halls on Gun Action', 'naomi wadler', 'RVA March For Our Lives Rally', 'As a lawmaker, he works against the', 'March for Our Lives Speech by an 11-Year-Old Girl', 'possibly the best sign I saw at the March For Our Lives today', 'March for our Lives rally in Richmond, VA', 'fossil fuel gospel in virginia', 'fake news in black churches', 'alex jones is a menace to society', 'gerrymandering in virginia', 'Mary checking visa status of prospective students', 'burgos', 'va-5', 'tim kaine', 'Va. House seat', 'corey stewart', 'rob wittman', 'scott taylor', 'rep. taylor', 'congressman taylor', 'rep taylor', 'Virginia Congressional Election', 'dave brat', 'rep. brat', 'congressman brat', 'rep brat', 'representative brat', 'Conservatives drop demands for bigger spending cuts to get to tax reform', 'GOP Congressmen Call For Mueller Hearings', 'Republicans in Congress Cheered', 'Freedom Caucus endorses GOP tax plan', 'goodlatte', 'wave of Republicans leaving Congress', 'House Judiciary chairman', 'U.S. House panels open probe into Justice Department', 'House GOP leaders open probe into FBI', 'latest Republican patsy', 'Lawmakers grapple with warrantless wiretapping program', 'barbara comstock', 'rep. comstock', 'congresswoman comstock', 'rep comstock', 'representative comstock', 'va-10', 'comstock challenger', 'Dems think Trump can deliver suburbs to their party', 'Every Member of Congress Who Took Money From the NRA and Tweeted', 'who in Congress is getting money from the NRA', 'Obamacare repeal effort into doubt', 'tom hicks']
            for term in terms:
