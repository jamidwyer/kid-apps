...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['Texans turn out in force on first day of early voting', 'Bexar County, Texas police', '6, killed by police days before Christmas', 'Like where do we draw the line']
            for term in terms:
