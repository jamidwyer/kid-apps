...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['west virginia teacher strike', 'w.va lawmaker', 'west virginia teachers\'', 'the west virginia spring', 'west virginia teachers are now out on a wildcat strike', 'West Virginia politician', 'West Virginia Teachers Win', 'Saving West Virginia', 'defamation lawsuit against John Oliver', 'West Virginia teachers take a stand', 'Teachers strike across West Virginia', 'West Virginia teachers stage walkout', 'Teachers shutdown the entire state of West Virginia', 'West Virginia\'s public schools are closed due to a teacher walk-out over pay', 'Thousands rally to defend teachers in Charleston, West Virginia', 'Trump Can\'t Save Coal', 'lissa lucas', 'Applause for Candidate Who Called Out Big Oil Donors', 'west virginia legislature', 'Progressive Revolt Is Brewing in West Virginia', 'Candidate KICKED OUT For Reading Politicians', 'Police officer fired for not shooting black suspect', 'West Virginia Woman Dragged Out of Capitol', 'West Virginia was dragged out of the capitol', 'WV House Chambers', 'I would LOVE to see TYT interview this woman', 'West Virginia Democratic Candidate', 'dragged out of West Virginia house hearing listing oil and gas contributions', 'kicked out of a town hall in west Virginia for simply listing corporate donors', 'wv-sen', 'West Virginia Senate GOP Primary', 'Trump is on his way to West Virginia', 'manchin', 'paulajean2018', 'West Virginia started drug testing welfare recipients', 'Richard Ojeda', 'Appalachia poor, sick, and stuck on coal', 'Dire Impressions From His Report On Poverty In U.S.', 'dead because of this coal baron', 'CEO who oversaw a mine where 29 workers were killed']
            for term in terms:
