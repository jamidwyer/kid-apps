...
def search(term, submission):
    if re.search(term, submission.title, re.IGNORECASE):
        ...
        text = ("Wyoming 2018 Election \n\n"
            "[General Election](http://soswy.state.wy.us/Elections/PollPlace/Default.aspx): November 6, 2018 \n\n")
