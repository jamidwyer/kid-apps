...
def searchAndPost(sub):
    ...
    for submission in subreddit.hot(limit=50):
        ...
        if submission.id not in posts_replied_to:
            ...
            terms = ['j.p johnson', 'mo-79', 'Missouri will get to vote on medical cannabis', '3 medical cannabis initiatives qualify for November ballot', 'trump visits granite city', 'st. louis minimum wage', 'John Goodman hits Missouri airwaves', 'John Goodman lends voice against Missouri', 'Gay Rights icon, Mike Pence', 'Kansas City will greet Mike Pence', 'Tariffs Have Led to Layoffs', 'missouri congress', 'layoffs from Trump', 'Nail manufacturing exec who voted for Trump', 'Missouri nail manufacturer planning to lay off', 'michael brown was shot', 'Missouri Is Already Blocking Medicaid', 'curtiswylde', 'greitens', 'lauren arthur', 'missouripolitics', 'ferguson city council', 'missouri house moves', 'kc voters', 'osmack', 'missouri bill', 'new approach missouri', 'Missouri lawmaker', 'austin petersen', 'Missouri Medical Marijuana Campaign', 'josh hawley', 'courtland sykes', 'US Senate in Missouri', 'MO GOP Senate Nomination', 'snake-filled heads', 'career obsessed banshees', 'Missouri pregnancy mortality', 'sam graves', 'public owned ISP in St. Louis City and County', 'Blaine Luetkemeyer', 'Louis Cops Lead Nation in Rate of Police Shootings', 'Public defenders say they\'re overworked and underfunded', 'KC based protests over Net Neutrality', 'kathy ellis', 'mccaskill', 'top 10 Senate races of 2018', 'ann wagner', 'mo-2', 'jenna marie bourgeois', 'hartzler', 'mo-4', 'How Missouri previewed Democrats']
            for term in terms:
